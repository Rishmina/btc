...
export default function Header() {
    ...
    const navigation = [
        ...
        { name: 'About', href: '#about' },
        {
            ...
            href: '#services',
            children: [
                { name: 'Design Bespoke or In House Corporate Training', href: '/services/design-bespoke-or-in-house-corporate-training' },
                { name: 'Public Corporate Training', href: '/services/public-corporate-training' },
                { name: 'Management Courses', href: '/services/management-courses' },
                { name: 'Leadership Courses', href: '/services/leadership-courses' },
                { name: 'HR & Administration Courses', href: '/services/hr-and-administration-courses' },
                { name: 'Personality Development Courses', href: '/services/personality-development-courses' },
                { name: 'Finance Courses', href: '/services/finance-courses' },
                { name: 'Language Courses', href: '/services/language-courses' },
                { name: 'Microsoft Office Courses', href: '/services/microsoft-office-courses' },
                { name: 'Marketing & Sales Courses', href: '/services/marketing-and-sales-courses' },
                { name: 'IT Courses', href: '/services/it-courses' },
                { name: 'Technical Courses', href: '/services/technical-courses' },
                { name: 'Project Management Courses', href: '/services/project-management-courses' },
            ],
        },
        {
            name: 'Courses',
